...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move VICEGRIP,     EFFECT_NORMAL_HIT,         65, NORMAL,       100, 30,   0 ;Updated from 55 BP to 65 BP
	...
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         45, GRASS,        100, 15,   0  ;Updated from 35 to 45 BP, PP increase to 15 from 10
	...
	move TACKLE,       EFFECT_NORMAL_HIT,         40, NORMAL,        95, 35,   0
	...
	move TWINEEDLE,    EFFECT_POISON_MULTI_HIT,   35, BUG,          100, 20,  20 ;Updated from 25 BP to 35 BP
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          20, BUG,           85, 20,   0 ; Updated from 14 BP to 20BP
	...
	move PECK,         EFFECT_NORMAL_HIT,         40, FLYING,       100, 35,   0 ;BP increase from 35 to 40
	...
	move PETAL_DANCE,  EFFECT_RAMPAGE,            95, GRASS,        100, 20,   0 ; Upgraded from 75 to 95 BP
	...
	move KINESIS,      EFFECT_ACCURACY_DOWN,       0, PSYCHIC_TYPE, 100, 15,   0 ; Increased accuracy to 100
	move SOFTBOILED,   EFFECT_HEAL,                0, NORMAL,       100, 10,   0
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,          130, FIGHTING,     75, 20,   0 ; Increased BP to 130; reduced accuracy to 75
	...
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          45, BUG,          100, 15,   0 ;Increased BP from 20 to 45
	...
	move OUTRAGE,      EFFECT_RAMPAGE,            95, DRAGON,       100, 15,   0 ; Increased BP from 90 to 95
