...
FalknerGroup:
	...
	db  9,  NATU,      PECK, MUD_SLAP, LEER, CONFUSION
	db  11, NOCTOWL,   TACKLE, MUD_SLAP, WING_ATTACK, GROWL
	db -1 ; end
...
YoungsterGroup:
	...
	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 65, RATICATE,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
BugCatcherGroup:
	...
	db 27, BUTTERFREE, CONFUSION, SLEEP_POWDER, SUPERSONIC, WHIRLWIND
	db 27, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, SLUDGE_BOMB, RAGE
	db -1 ; end

	; BUG_CATCHER (16)
	db "WADE@", TRAINERTYPE_MOVES
	db 52, BUTTERFREE, PSYBEAM, POISONPOWDER, SUPERSONIC, GUST
    db 52, BEEDRILL, PIN_MISSILE, FOCUS_ENERGY, TWINEEDLE, RAGE
    db 55, BUTTERFREE, PSYCHIC_M, SLEEP_POWDER, SUPERSONIC, WHIRLWIND
    db 55, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, SLUDGE_BOMB, HYPER_BEAM
	db -1 ; end
